...
func (_m *ModuleRepository) GetAllModules(m *[]models.Modules, keyword string, sorting string, sortField string, page string, limit string, focus string) error {
...
func (_m *ModuleRepository) GetModule(m *models.Modules, id uint) error {
	ret := _m.Called(m, id)
...
func (_m *ModuleRepository) UpdateModule(m *models.Modules, id uint) error {
	ret := _m.Called(m, id)
