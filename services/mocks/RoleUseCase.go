...
func (_m *RoleUseCase) CreateRole(m *models.RoleItems) error {
	ret := _m.Called(m)
...
func (_m *RoleUseCase) DeleteRoles(focus string, id []int) (int64, error) {
...
func (_m *RoleUseCase) GetRole(m *models.RoleItems, id string) error {
	ret := _m.Called(m, id)
...
func (_m *RoleUseCase) RestoreRoles(id []int) (int64, error) {
	ret := _m.Called(id)
...
func (_m *RoleUseCase) UpdateRole(m *models.RoleItems, id string) error {
	ret := _m.Called(m, id)
